...
PROMPTS = {
    ...
    # --- NEW IMAGES ---
    "knowledge-lenses": """
A grid or wheel diagram showing 13 research lenses for AI/ML, arranged by verifiability.
Top (most verifiable): Computational Efficiency, Algorithmic Framing, Training Stability, Hardware-Aware Design
Middle: Compute Regimes, Representational Capacity, Data as First-Class, Probabilistic Inference, Strategic Interaction
Bottom (least verifiable): Physical Principles, Meta-Learning, Cognitive Substrate, Biological Optimization, Philosophical Foundations

Style: Clean infographic with a gradient from green (top/verifiable) to red (bottom/hard to verify).
White background, modern sans-serif labels. Each lens has a small icon.
Professional academic aesthetic. No people.
""",
}
