      ...
      >
        ...
        <ArticleSection>
          <div className="text-lg leading-relaxed space-y-6 text-neutral-900">
            ...
            <p>
              It started from understanding the fundamental building block of
              the brain, <span className="font-semibold">the neuron</span>, when
              Golgi figured out staining. Others built on this work and we
            ...
            <p>
              And that the biggest part of our brain, the cerebrum, is broadly
              the same building block copied over and over again with the simple
